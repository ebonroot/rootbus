...
def main():
    ...
    Syntax: {cmd} {{path/to/src/model.ex}} {{path/to/dst/model.ex}} SnakeDbBefore SnakeDbAfter
            {cmd} {{path/to/dst/model.ex}} SnakeDbAfter
...
def convert_it(src, dst, pascal_before, pascal_after, plus, test=False):
    ...
    if os.path.exists(path2):
        print("Skipping: {}, already exists".format(path2))
        return
